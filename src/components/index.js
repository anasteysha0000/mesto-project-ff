...
import {placesElement,popupTypeEdit,popupTypeNewCard,popupOpenEditButton,popupAddButton,popupTypeImage,popupTypeAvatar,popups,formElement,nameInput,jobInput,
  formElementTypeNewCard,cardName,cardLink,profileName,profileDescription,profileAvatar,formElementTypeAvatar,inputUrl} from './constants.js'
import { cardsInfo, userInfo,editProfile, newCard,editAvatar} from "./api.js";
...
function handleCardSubmit(evt) {
  ...
  newCard(card)
  .then((card)=>{
    placesElement.prepend(getCard(card, deleteCardButton, toggleLikeButton, openImage,card.owner._id))
...
Promise.all([userInfo(),cardsInfo()])
  ...
  card.forEach((element) => {
        const cardAdd = getCard(element, deleteCardButton, toggleLikeButton, openImage, owner)
...
profileAvatar.addEventListener('click', function() {
  ...
  clearValidation(formElementTypeAvatar, {
  formSelector: '.popup__form',
  inputSelector: '.popup__input',
  submitButtonSelector: '.popup__button',
  inactiveButtonClass: 'popup__button_disabled',
